...
- [x] Added new method to `GatewayAccount`: `getAdditionalFilters`, `setAdditionalFilters`

### Deprecated
- [x] Deprecated `PayPalAccount` method: `getApprovalLink`
- [x] Deprecated `GatewayAccount` method: `getAdditionalCriteria`, `setAdditionalCriteria`, `createAdditionalCriteria`
