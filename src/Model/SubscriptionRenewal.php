...
class SubscriptionRenewal implements JsonSerializable
{
    ...
    /**
     * @return null|SubscriptionRenewalData[]
     */
    ...
    public function setData(null|array $data): static
    {
        $data = $data !== null ? array_map(
            fn ($value) => $value instanceof SubscriptionRenewalData ? $value : SubscriptionRenewalData::from($value),
            $data,
        ) : null;
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('data', $this->fields)) {
            $data['data'] = $this->fields['data'] !== null
                ? array_map(
                    static fn (SubscriptionRenewalData $subscriptionRenewalData) => $subscriptionRenewalData->jsonSerialize(),
                    $this->fields['data'],
                )
                : null;
        }
