...
class LeadSource implements JsonSerializable
{
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('original', $this->fields)) {
            $data['original'] = $this->fields['original']?->jsonSerialize();
        }
    ...
    private function setOriginal(null|LeadSourceData|array $original): self
    {
