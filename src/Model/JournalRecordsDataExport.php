...
class JournalRecordsDataExport implements DataExport
{
    ...
    public function getEmbedded(): ?JournalRecordsDataExportEmbedded
    {
        return $this->fields['_embedded'] ?? null;
    }

    public function setEmbedded(null|JournalRecordsDataExportEmbedded|array $embedded): static
    {
        if ($embedded !== null && !($embedded instanceof JournalRecordsDataExportEmbedded)) {
            $embedded = JournalRecordsDataExportEmbedded::from($embedded);
        }
