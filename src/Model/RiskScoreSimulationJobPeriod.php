...
class RiskScoreSimulationJobPeriod implements JsonSerializable
{
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('startDate', $this->fields)) {
            $data['startDate'] = $this->fields['startDate']?->format(DateTimeInterface::RFC3339);
        }
        if (array_key_exists('endDate', $this->fields)) {
            $data['endDate'] = $this->fields['endDate']?->format(DateTimeInterface::RFC3339);
        }
