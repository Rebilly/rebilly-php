...
class QuoteCreateOrderItems implements JsonSerializable
{
    ...
    public function getUsageLimits(): ?QuoteCreateOrderItemsUsageLimits
    {
        return $this->fields['usageLimits'] ?? null;
    }

    public function setUsageLimits(null|QuoteCreateOrderItemsUsageLimits|array $usageLimits): static
    {
        if ($usageLimits !== null && !($usageLimits instanceof QuoteCreateOrderItemsUsageLimits)) {
            $usageLimits = QuoteCreateOrderItemsUsageLimits::from($usageLimits);
        }
