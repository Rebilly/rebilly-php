...
class Airwallex extends GatewayAccount
{
    ...
    public function setCredentials(AirwallexCredentials|array $credentials): static
    {
        if (!($credentials instanceof AirwallexCredentials)) {
            $credentials = AirwallexCredentials::from($credentials);
        }
    ...
    public function getSettings(): ?AirwallexSettings
    {
        return $this->fields['settings'] ?? null;
    }

    public function setSettings(null|AirwallexSettings|array $settings): static
    {
        if ($settings !== null && !($settings instanceof AirwallexSettings)) {
            $settings = AirwallexSettings::from($settings);
        }
