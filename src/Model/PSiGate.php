...
class PSiGate extends GatewayAccount
{
    ...
    public function setCredentials(PSiGateCredentials|array $credentials): static
    {
        if (!($credentials instanceof PSiGateCredentials)) {
            $credentials = PSiGateCredentials::from($credentials);
        }
