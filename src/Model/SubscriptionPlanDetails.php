...
class SubscriptionPlanDetails implements Plan
{
    use HasMetadata;
    ...
    public function setRecurringInterval(SubscriptionPlanDetailsRecurringInterval|array $recurringInterval): static
    {
        if (!($recurringInterval instanceof SubscriptionPlanDetailsRecurringInterval)) {
            $recurringInterval = SubscriptionPlanDetailsRecurringInterval::from($recurringInterval);
        }
    ...
    public function getMeteredBilling(): ?SubscriptionPlanDetailsMeteredBilling
    {
        return $this->fields['meteredBilling'] ?? null;
    }

    public function setMeteredBilling(null|SubscriptionPlanDetailsMeteredBilling|array $meteredBilling): static
    {
        if ($meteredBilling !== null && !($meteredBilling instanceof SubscriptionPlanDetailsMeteredBilling)) {
            $meteredBilling = SubscriptionPlanDetailsMeteredBilling::from($meteredBilling);
        }
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('productOptions', $this->fields)) {
            $data['productOptions'] = $this->fields['productOptions'] !== null
                ? (object) $this->fields['productOptions']
                : null;
        }
