...
class DisputesDataExport implements DataExport
{
    ...
    public function getEmbedded(): ?DisputesDataExportEmbedded
    {
        return $this->fields['_embedded'] ?? null;
    }

    public function setEmbedded(null|DisputesDataExportEmbedded|array $embedded): static
    {
        if ($embedded !== null && !($embedded instanceof DisputesDataExportEmbedded)) {
            $embedded = DisputesDataExportEmbedded::from($embedded);
        }
