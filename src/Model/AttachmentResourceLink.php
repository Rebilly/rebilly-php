...
class AttachmentResourceLink implements JsonSerializable
{
    public const REL_CUSTOMER = 'customer';

    public const REL_DISPUTE = 'dispute';

    public const REL_INVOICE = 'invoice';

    public const REL_PAYMENT = 'payment';

    public const REL_PLAN = 'plan';

    public const REL_PRODUCT = 'product';

    public const REL_SUBSCRIPTION = 'subscription';

    public const REL_TRANSACTION = 'transaction';
