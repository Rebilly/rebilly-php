...
class DccMarkup implements JsonSerializable
{
    ...
    /**
     * @param null|array[]|DccMarkupData[] $data
     */
    public function setData(null|array $data): static
    {
        $data = $data !== null ? array_map(
            fn ($value) => $value instanceof DccMarkupData ? $value : DccMarkupData::from($value),
            $data,
        ) : null;
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('data', $this->fields)) {
            $data['data'] = $this->fields['data'] !== null
                ? array_map(
                    static fn (DccMarkupData $dccMarkupData) => $dccMarkupData->jsonSerialize(),
                    $this->fields['data'],
                )
                : null;
        }
