...
class BankAccountToken implements CompositeToken, JsonSerializable
{
    ...
    public function getPaymentInstrument(): BankAccountInstrument
    {
        return $this->fields['paymentInstrument'];
    }

    public function setPaymentInstrument(BankAccountInstrument|array $paymentInstrument): static
    {
        if (!($paymentInstrument instanceof BankAccountInstrument)) {
            $paymentInstrument = BankAccountInstrumentFactory::from($paymentInstrument);
        }
