...
class ApiLogSummary implements JsonSerializable
{
    ...
    public function setData(null|array $data): static
    {
        $data = $data !== null ? array_map(
            fn ($value) => $value instanceof ApiLogSummaryData ? $value : ApiLogSummaryData::from($value),
            $data,
        ) : null;
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('data', $this->fields)) {
            $data['data'] = $this->fields['data'] !== null
                ? array_map(
                    static fn (ApiLogSummaryData $apiLogSummaryData) => $apiLogSummaryData->jsonSerialize(),
                    $this->fields['data'],
                )
                : null;
        }
