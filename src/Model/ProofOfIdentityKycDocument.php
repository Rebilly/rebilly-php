...
class ProofOfIdentityKycDocument extends KycDocument
{
    ...
    public function setSettings(null|KycSettingsIdentity|array $settings): self
    {
        if ($settings !== null && !($settings instanceof \Rebilly\Sdk\Model\KycSettingsIdentity)) {
            $settings = \Rebilly\Sdk\Model\KycSettingsIdentity::from($settings);
        }
    ...
    public function setDocumentMatches(null|ProofOfIdentityKycDocumentDocumentMatches|array $documentMatches): self
    {
        if ($documentMatches !== null && !($documentMatches instanceof \Rebilly\Sdk\Model\ProofOfIdentityKycDocumentDocumentMatches)) {
            $documentMatches = \Rebilly\Sdk\Model\ProofOfIdentityKycDocumentDocumentMatches::from($documentMatches);
        }
    ...
    {
        if ($parsedData !== null && !($parsedData instanceof \Rebilly\Sdk\Model\ProofOfIdentityKycDocumentDocumentMatches)) {
            $parsedData = \Rebilly\Sdk\Model\ProofOfIdentityKycDocumentDocumentMatches::from($parsedData);
        }
