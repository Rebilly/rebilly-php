...
class ProofOfFundsKycDocument implements KycDocument, JsonSerializable
{
    ...
    public function getDocumentMatches(): ?ProofOfFundsKycDocumentDocumentMatches
    {
        return $this->fields['documentMatches'] ?? null;
    }

    public function setDocumentMatches(null|ProofOfFundsKycDocumentDocumentMatches|array $documentMatches): static
    {
        if ($documentMatches !== null && !($documentMatches instanceof ProofOfFundsKycDocumentDocumentMatches)) {
            $documentMatches = ProofOfFundsKycDocumentDocumentMatches::from($documentMatches);
        }
    ...
    public function setParsedData(null|ProofOfFundsKycDocumentParsedData|array $parsedData): static
    {
    ...
    public function getEmbedded(): ?ProofOfFundsKycDocumentEmbedded
    {
        return $this->fields['_embedded'] ?? null;
    }

    public function setEmbedded(null|ProofOfFundsKycDocumentEmbedded|array $embedded): static
    {
        if ($embedded !== null && !($embedded instanceof ProofOfFundsKycDocumentEmbedded)) {
            $embedded = ProofOfFundsKycDocumentEmbedded::from($embedded);
        }
