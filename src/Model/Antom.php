...
class Antom extends GatewayAccount
{
    ...
    public function setCredentials(AntomCredentials|array $credentials): static
    {
        if (!($credentials instanceof AntomCredentials)) {
            $credentials = AntomCredentials::from($credentials);
        }
