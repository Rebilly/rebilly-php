...
class Paybilt extends GatewayAccount
{
    ...
    public function setCredentials(PaybiltCredentials|array $credentials): static
    {
        if (!($credentials instanceof PaybiltCredentials)) {
            $credentials = PaybiltCredentials::from($credentials);
        }
