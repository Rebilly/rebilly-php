...
class PayGlocalCredentials implements JsonSerializable
{
    use HasMetadata;
    ...
    public function __construct(array $data = [], array $metadata = [])
    {
        ...
        if (array_key_exists('privateKeyId', $data)) {
            $this->setPrivateKeyId($data['privateKeyId']);
        }
    ...
    {
        return $this->fields['privateKeyId'];
    }

    public function setPrivateKeyId(string $privateKeyId): static
    {
        $this->fields['privateKeyId'] = $privateKeyId;
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('privateKeyId', $this->fields)) {
            $data['privateKeyId'] = $this->fields['privateKeyId'];
        }
