...
class Loonio extends GatewayAccount
{
    ...
    public function setCredentials(LoonioCredentials|array $credentials): static
    {
        if (!($credentials instanceof LoonioCredentials)) {
            $credentials = LoonioCredentials::from($credentials);
        }
