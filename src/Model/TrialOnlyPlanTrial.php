...
class TrialOnlyPlanTrial implements JsonSerializable
{
    ...
    public function getPeriod(): TrialOnlyPlanTrialPeriod
    {
        return $this->fields['period'];
    }

    public function setPeriod(TrialOnlyPlanTrialPeriod|array $period): static
    {
        if (!($period instanceof TrialOnlyPlanTrialPeriod)) {
            $period = TrialOnlyPlanTrialPeriod::from($period);
        }
