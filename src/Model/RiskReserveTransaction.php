...
class RiskReserveTransaction extends BalanceTransaction
{
    ...
    public function __construct(array $data = [])
    {
        ...
        if (array_key_exists('riskReserveDetails', $data)) {
            $this->setRiskReserveDetails($data['riskReserveDetails']);
        }
    ...
    public function getRiskReserveDetails(): ?RiskReserveDetails
    {
    ...
    {
        if ($riskReserveDetails !== null && !($riskReserveDetails instanceof \Rebilly\Sdk\Model\RiskReserveDetails)) {
            $riskReserveDetails = \Rebilly\Sdk\Model\RiskReserveDetails::from($riskReserveDetails);
        }

        $this->fields['riskReserveDetails'] = $riskReserveDetails;
    ...
    {
        $data = [];
        if (array_key_exists('riskReserveDetails', $this->fields)) {
            $data['riskReserveDetails'] = $this->fields['riskReserveDetails']?->jsonSerialize();
        }
