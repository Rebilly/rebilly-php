...
class ProofOfAddressKycDocument implements KycDocument, JsonSerializable
{
    ...
    public function getParsedData(): ?ProofOfAddressKycDocumentParsedData
    {
        return $this->fields['parsedData'] ?? null;
    }

    public function setParsedData(null|ProofOfAddressKycDocumentParsedData|array $parsedData): static
    {
        if ($parsedData !== null && !($parsedData instanceof ProofOfAddressKycDocumentParsedData)) {
            $parsedData = ProofOfAddressKycDocumentParsedData::from($parsedData);
        }
    ...
    public function getEmbedded(): ?ProofOfAddressKycDocumentEmbedded
    {
        return $this->fields['_embedded'] ?? null;
    }

    public function setEmbedded(null|ProofOfAddressKycDocumentEmbedded|array $embedded): static
    {
        if ($embedded !== null && !($embedded instanceof ProofOfAddressKycDocumentEmbedded)) {
            $embedded = ProofOfAddressKycDocumentEmbedded::from($embedded);
        }
    ...
    private function setSettings(null|KycSettingsAddress|array $settings): static
    {
