...
class PostAvalaraCredential implements PostServiceCredentialRequest
{
    use HasMetadata;
    ...
    {
        return $this->fields['licenseKey'] ?? null;
    }

    public function setLicenseKey(null|string $licenseKey): static
    {
