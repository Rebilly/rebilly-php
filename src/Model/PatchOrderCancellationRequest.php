...
class PatchOrderCancellationRequest implements JsonSerializable
{
    ...
    /**
     * @return null|OrderCancellationLineItems[]
     */
    ...
    /**
     * @param null|array[]|OrderCancellationLineItems[] $lineItems
     */
    public function setLineItems(null|array $lineItems): static
    {
        $lineItems = $lineItems !== null ? array_map(
            fn ($value) => $value instanceof OrderCancellationLineItems ? $value : OrderCancellationLineItems::from($value),
            $lineItems,
        ) : null;
    ...
    public function getLineItemSubtotal(): ?OrderCancellationLineItemSubtotal
    {
        return $this->fields['lineItemSubtotal'] ?? null;
    }

    public function setLineItemSubtotal(null|OrderCancellationLineItemSubtotal|array $lineItemSubtotal): static
    {
        if ($lineItemSubtotal !== null && !($lineItemSubtotal instanceof OrderCancellationLineItemSubtotal)) {
            $lineItemSubtotal = OrderCancellationLineItemSubtotal::from($lineItemSubtotal);
        }
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('lineItems', $this->fields)) {
            $data['lineItems'] = $this->fields['lineItems'] !== null
                ? array_map(
                    static fn (OrderCancellationLineItems $orderCancellationLineItems) => $orderCancellationLineItems->jsonSerialize(),
