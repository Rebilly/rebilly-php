...
class PayRedeem extends GatewayAccount
{
    ...
    public function setCredentials(PayRedeemCredentials|array $credentials): static
    {
        if (!($credentials instanceof PayRedeemCredentials)) {
            $credentials = PayRedeemCredentials::from($credentials);
        }
