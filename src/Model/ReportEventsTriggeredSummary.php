...
class ReportEventsTriggeredSummary implements JsonSerializable
{
    ...
    /**
     * @return null|ReportEventsTriggeredSummaryData[]
     */
    ...
    public function setData(null|array $data): static
    {
        $data = $data !== null ? array_map(
            fn ($value) => $value instanceof ReportEventsTriggeredSummaryData ? $value : ReportEventsTriggeredSummaryData::from($value),
            $data,
        ) : null;
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('data', $this->fields)) {
            $data['data'] = $this->fields['data'] !== null
                ? array_map(
                    static fn (ReportEventsTriggeredSummaryData $reportEventsTriggeredSummaryData) => $reportEventsTriggeredSummaryData->jsonSerialize(),
                    $this->fields['data'],
                )
                : null;
        }
