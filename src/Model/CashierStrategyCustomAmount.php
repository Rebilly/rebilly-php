...
class CashierStrategyCustomAmount implements JsonSerializable
{
    ...
    public function setMinimum(float|string $minimum): self
    {
    ...
    public function setMultipleOf(float|string $multipleOf): self
    {
    ...
    public function setMaximum(float|string $maximum): self
    {
