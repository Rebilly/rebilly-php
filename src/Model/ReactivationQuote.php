...
class ReactivationQuote implements Quote
{
    ...
    /**
     * @return null|ReactivationQuoteAcceptanceFulfillment[]
     */
    ...
    public function getOrder(): ReactivationQuoteOrder
    {
        return $this->fields['order'];
    }

    public function setOrder(ReactivationQuoteOrder|array $order): static
    {
        if (!($order instanceof ReactivationQuoteOrder)) {
            $order = ReactivationQuoteOrder::from($order);
        }
    ...
    public function getInvoicePreview(): ?ReactivationQuoteInvoicePreview
    {
        return $this->fields['invoicePreview'] ?? null;
    }

    public function setInvoicePreview(null|ReactivationQuoteInvoicePreview|array $invoicePreview): static
    {
        if ($invoicePreview !== null && !($invoicePreview instanceof ReactivationQuoteInvoicePreview)) {
            $invoicePreview = ReactivationQuoteInvoicePreview::from($invoicePreview);
        }
    ...
    public function getSignature(): ?ReactivationQuoteSignature
    {
        return $this->fields['signature'] ?? null;
    }

    public function setSignature(null|ReactivationQuoteSignature|array $signature): static
    {
        if ($signature !== null && !($signature instanceof ReactivationQuoteSignature)) {
            $signature = ReactivationQuoteSignature::from($signature);
        }
    ...
    public function getEmbedded(): ?ReactivationQuoteEmbedded
    {
        return $this->fields['_embedded'] ?? null;
    }

    public function setEmbedded(null|ReactivationQuoteEmbedded|array $embedded): static
    {
        if ($embedded !== null && !($embedded instanceof ReactivationQuoteEmbedded)) {
            $embedded = ReactivationQuoteEmbedded::from($embedded);
        }
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('acceptanceFulfillment', $this->fields)) {
            $data['acceptanceFulfillment'] = $this->fields['acceptanceFulfillment'] !== null
                ? array_map(
                    static fn (ReactivationQuoteAcceptanceFulfillment $reactivationQuoteAcceptanceFulfillment) => $reactivationQuoteAcceptanceFulfillment->jsonSerialize(),
    ...
    /**
     * @param null|array[]|ReactivationQuoteAcceptanceFulfillment[] $acceptanceFulfillment
     */
    private function setAcceptanceFulfillment(null|array $acceptanceFulfillment): static
    {
        $acceptanceFulfillment = $acceptanceFulfillment !== null ? array_map(
            fn ($value) => $value instanceof ReactivationQuoteAcceptanceFulfillment ? $value : ReactivationQuoteAcceptanceFulfillment::from($value),
