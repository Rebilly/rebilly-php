...
class Walpay extends GatewayAccount
{
    ...
    public function setCredentials(WalpayCredentials|array $credentials): static
    {
    ...
    public function setThreeDSecureServer(null|Walpay3dsServers|array $threeDSecureServer): static
    {
