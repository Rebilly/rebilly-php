...
class Tabby extends GatewayAccount
{
    ...
    public function setCredentials(TabbyCredentials|array $credentials): static
    {
        if (!($credentials instanceof TabbyCredentials)) {
            $credentials = TabbyCredentials::from($credentials);
        }
