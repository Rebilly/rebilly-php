...
class GetKycAcceptanceSummaryResponseDataStatusStatisticsRejected implements JsonSerializable
{
    ...
    public function setAfterAutoAccepted(null|int $afterAutoAccepted): static
    {
