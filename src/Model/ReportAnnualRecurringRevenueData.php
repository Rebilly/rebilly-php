...
class ReportAnnualRecurringRevenueData implements JsonSerializable
{
    ...
    public function getBreakdown(): ?ReportAnnualRecurringRevenueDataBreakdown
    {
        return $this->fields['breakdown'] ?? null;
    }

    public function setBreakdown(null|ReportAnnualRecurringRevenueDataBreakdown|array $breakdown): static
    {
        if ($breakdown !== null && !($breakdown instanceof ReportAnnualRecurringRevenueDataBreakdown)) {
            $breakdown = ReportAnnualRecurringRevenueDataBreakdown::from($breakdown);
        }
