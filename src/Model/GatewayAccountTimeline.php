...
class GatewayAccountTimeline implements JsonSerializable
{
    ...
    public const TYPE_ENABLED = 'gateway-account-enabled';

    public const TYPE_DISABLED = 'gateway-account-disabled';

    public const TYPE_DOWN = 'gateway-account-down';

    public const TYPE_UP = 'gateway-account-up';

    public const TYPE_CLOSED = 'gateway-account-closed';

    public const TYPE_LIMIT_REACHED = 'gateway-account-limit-reached';

    public const TYPE_LIMIT_RESET = 'gateway-account-limit-reset';

    public const TYPE_ONBOARDING_COMPLETED = 'gateway-account-onboarding-completed';
