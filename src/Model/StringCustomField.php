...
class StringCustomField implements CustomField, JsonSerializable
{
    ...
    public function getAdditionalSchema(): ?StringCustomFieldAdditionalSchema
    {
        return $this->fields['additionalSchema'] ?? null;
    }

    public function setAdditionalSchema(null|StringCustomFieldAdditionalSchema|array $additionalSchema): static
    {
        if ($additionalSchema !== null && !($additionalSchema instanceof StringCustomFieldAdditionalSchema)) {
            $additionalSchema = StringCustomFieldAdditionalSchema::from($additionalSchema);
        }
