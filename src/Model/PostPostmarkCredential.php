...
class PostPostmarkCredential implements PostServiceCredentialRequest
{
    use HasMetadata;
    ...
    {
        return $this->fields['serverApiToken'] ?? null;
    }

    public function setServerApiToken(null|string $serverApiToken): static
    {
