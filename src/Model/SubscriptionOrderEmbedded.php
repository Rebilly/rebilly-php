...
class SubscriptionOrderEmbedded implements JsonSerializable
{
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('initialInvoice', $this->fields)) {
            $data['initialInvoice'] = $this->fields['initialInvoice'];
        }
        ...
        if (array_key_exists('upcomingInvoice', $this->fields)) {
            $data['upcomingInvoice'] = $this->fields['upcomingInvoice'];
        }
