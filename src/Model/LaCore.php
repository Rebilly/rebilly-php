...
class LaCore extends GatewayAccount
{
    ...
    public function setCredentials(LaCoreCredentials|array $credentials): static
    {
        if (!($credentials instanceof LaCoreCredentials)) {
            $credentials = LaCoreCredentials::from($credentials);
        }
