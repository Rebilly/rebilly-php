...
class PatchBroadcastMessageMessages implements JsonSerializable
{
    use HasMetadata;
    ...
    /**
     * @return PatchBroadcastMessageMessagesTemplates[]
     */
    ...
    /**
     * @param array[]|PatchBroadcastMessageMessagesTemplates[] $templates
     */
    public function setTemplates(array $templates): static
    {
        $templates = array_map(
            fn ($value) => $value instanceof PatchBroadcastMessageMessagesTemplates ? $value : PatchBroadcastMessageMessagesTemplates::from($value),
            $templates,
        );
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('templates', $this->fields)) {
            $data['templates'] = array_map(
                static fn (PatchBroadcastMessageMessagesTemplates $patchBroadcastMessageMessagesTemplates) => $patchBroadcastMessageMessagesTemplates->jsonSerialize(),
