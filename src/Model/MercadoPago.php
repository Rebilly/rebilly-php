...
class MercadoPago extends GatewayAccount
{
    ...
    public function getSettings(): ?MercadoPagoSettings
    {
        return $this->fields['settings'] ?? null;
    }

    public function setSettings(null|MercadoPagoSettings|array $settings): static
    {
        if ($settings !== null && !($settings instanceof MercadoPagoSettings)) {
            $settings = MercadoPagoSettings::from($settings);
        }
