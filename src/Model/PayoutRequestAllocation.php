...
class PayoutRequestAllocation implements JsonSerializable
{
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('transactionResult', $this->fields)) {
            $data['transactionResult'] = $this->fields['transactionResult']?->jsonSerialize();
        }
        if (array_key_exists('transactionStatus', $this->fields)) {
            $data['transactionStatus'] = $this->fields['transactionStatus']?->jsonSerialize();
        }
    ...
    private function setTransactionResult(null|TransactionResult|array $transactionResult): static
    {
        if ($transactionResult !== null && !($transactionResult instanceof TransactionResult)) {
            $transactionResult = TransactionResult::from($transactionResult);
        }
    ...
    private function setTransactionStatus(null|TransactionStatus|array $transactionStatus): static
    {
        if ($transactionStatus !== null && !($transactionStatus instanceof TransactionStatus)) {
            $transactionStatus = TransactionStatus::from($transactionStatus);
        }
