...
class CreationQuote implements Quote
{
    ...
    /**
     * @return null|CreationQuoteAcceptanceFulfillment[]
     */
    ...
    public function getOrder(): CreationQuoteOrder
    {
        return $this->fields['order'];
    }

    public function setOrder(CreationQuoteOrder|array $order): static
    {
        if (!($order instanceof CreationQuoteOrder)) {
            $order = CreationQuoteOrder::from($order);
        }
    ...
    public function getInvoicePreview(): ?CreationQuoteInvoicePreview
    {
        return $this->fields['invoicePreview'] ?? null;
    }

    public function setInvoicePreview(null|CreationQuoteInvoicePreview|array $invoicePreview): static
    {
        if ($invoicePreview !== null && !($invoicePreview instanceof CreationQuoteInvoicePreview)) {
            $invoicePreview = CreationQuoteInvoicePreview::from($invoicePreview);
        }
    ...
    public function getSignature(): ?CreationQuoteSignature
    {
        return $this->fields['signature'] ?? null;
    }

    public function setSignature(null|CreationQuoteSignature|array $signature): static
    {
        if ($signature !== null && !($signature instanceof CreationQuoteSignature)) {
            $signature = CreationQuoteSignature::from($signature);
        }
    ...
    public function getEmbedded(): ?CreationQuoteEmbedded
    {
        return $this->fields['_embedded'] ?? null;
    }

    public function setEmbedded(null|CreationQuoteEmbedded|array $embedded): static
    {
        if ($embedded !== null && !($embedded instanceof CreationQuoteEmbedded)) {
            $embedded = CreationQuoteEmbedded::from($embedded);
        }
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('acceptanceFulfillment', $this->fields)) {
            $data['acceptanceFulfillment'] = $this->fields['acceptanceFulfillment'] !== null
                ? array_map(
                    static fn (CreationQuoteAcceptanceFulfillment $creationQuoteAcceptanceFulfillment) => $creationQuoteAcceptanceFulfillment->jsonSerialize(),
    ...
    /**
     * @param null|array[]|CreationQuoteAcceptanceFulfillment[] $acceptanceFulfillment
     */
    private function setAcceptanceFulfillment(null|array $acceptanceFulfillment): static
    {
        $acceptanceFulfillment = $acceptanceFulfillment !== null ? array_map(
            fn ($value) => $value instanceof CreationQuoteAcceptanceFulfillment ? $value : CreationQuoteAcceptanceFulfillment::from($value),
