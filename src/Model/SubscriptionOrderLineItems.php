...
class SubscriptionOrderLineItems implements JsonSerializable
{
    ...
    {
        return $this->fields['unitPriceAmount'] ?? null;
    }

    public function setUnitPriceAmount(null|float|string $unitPriceAmount): static
    {
    ...
    {
        return $this->fields['unitPriceCurrency'] ?? null;
    }

    public function setUnitPriceCurrency(null|string $unitPriceCurrency): static
    {
