...
class PlaidAccountToken implements CompositeToken, JsonSerializable
{
    ...
    public function setPaymentInstrument(PlaidAccountTokenPaymentInstrument|array $paymentInstrument): static
    {
