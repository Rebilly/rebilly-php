...
class QuoteTrialConversionOrderItems implements JsonSerializable
{
    ...
    public function getUsageLimits(): ?QuoteTrialConversionOrderItemsUsageLimits
    {
        return $this->fields['usageLimits'] ?? null;
    }

    public function setUsageLimits(null|QuoteTrialConversionOrderItemsUsageLimits|array $usageLimits): static
    {
        if ($usageLimits !== null && !($usageLimits instanceof QuoteTrialConversionOrderItemsUsageLimits)) {
            $usageLimits = QuoteTrialConversionOrderItemsUsageLimits::from($usageLimits);
        }
    ...
    public function getEmbedded(): ?QuoteTrialConversionOrderItemsEmbedded
    {
        return $this->fields['_embedded'] ?? null;
    }

    public function setEmbedded(null|QuoteTrialConversionOrderItemsEmbedded|array $embedded): static
    {
        if ($embedded !== null && !($embedded instanceof QuoteTrialConversionOrderItemsEmbedded)) {
            $embedded = QuoteTrialConversionOrderItemsEmbedded::from($embedded);
        }
