...
class PostTaxJarCredential implements PostServiceCredentialRequest
{
    use HasMetadata;
    ...
    {
        return $this->fields['apiToken'] ?? null;
    }

    public function setApiToken(null|string $apiToken): static
    {
