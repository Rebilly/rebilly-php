...
class PatchPayoutRequestRequest implements JsonSerializable
{
    ...
    public function __construct(array $data = [], array $metadata = [])
    {
        ...
        if (array_key_exists('cancellationDescription', $data)) {
            $this->setCancellationDescription($data['cancellationDescription']);
        }
    ...
    {
        return $this->fields['cancellationDescription'] ?? null;
    }

    public function setCancellationDescription(null|string $cancellationDescription): static
    {
        $this->fields['cancellationDescription'] = $cancellationDescription;
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('cancellationDescription', $this->fields)) {
            $data['cancellationDescription'] = $this->fields['cancellationDescription'];
        }
