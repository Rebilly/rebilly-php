...
class RuleActionCreateIntuitQuickbooksInvoice extends RuleAction
{
    ...
    public function getTemplate(): ?RuleActionCreateIntuitQuickbooksInvoiceTemplate
    {
        return $this->fields['template'] ?? null;
    }

    public function setTemplate(null|RuleActionCreateIntuitQuickbooksInvoiceTemplate|array $template): static
    {
        if ($template !== null && !($template instanceof RuleActionCreateIntuitQuickbooksInvoiceTemplate)) {
            $template = RuleActionCreateIntuitQuickbooksInvoiceTemplate::from($template);
        }
