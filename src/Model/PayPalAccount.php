...
class PayPalAccount implements PaymentInstrument, PostPaymentInstrumentRequest, JsonSerializable
{
    ...
    public function getEmbedded(): ?PayPalAccountEmbedded
    {
        return $this->fields['_embedded'] ?? null;
    }

    public function setEmbedded(null|PayPalAccountEmbedded|array $embedded): static
    {
        if ($embedded !== null && !($embedded instanceof PayPalAccountEmbedded)) {
            $embedded = PayPalAccountEmbedded::from($embedded);
        }
