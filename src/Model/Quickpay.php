...
class Quickpay extends GatewayAccount
{
    use HasMetadata;
    ...
    public function getCredentials(): QuickpayCredentials
    {
        return $this->fields['credentials'];
    }

    public function setCredentials(QuickpayCredentials|array $credentials): static
    {
        if (!($credentials instanceof QuickpayCredentials)) {
            $credentials = QuickpayCredentials::from($credentials);
        }
