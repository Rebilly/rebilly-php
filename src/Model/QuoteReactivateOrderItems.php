...
class QuoteReactivateOrderItems implements JsonSerializable
{
    ...
    public function getUsageLimits(): ?QuoteReactivateOrderItemsUsageLimits
    {
        return $this->fields['usageLimits'] ?? null;
    }

    public function setUsageLimits(null|QuoteReactivateOrderItemsUsageLimits|array $usageLimits): static
    {
        if ($usageLimits !== null && !($usageLimits instanceof QuoteReactivateOrderItemsUsageLimits)) {
            $usageLimits = QuoteReactivateOrderItemsUsageLimits::from($usageLimits);
        }
    ...
    public function getEmbedded(): ?QuoteReactivateOrderItemsEmbedded
    {
        return $this->fields['_embedded'] ?? null;
    }

    public function setEmbedded(null|QuoteReactivateOrderItemsEmbedded|array $embedded): static
    {
        if ($embedded !== null && !($embedded instanceof QuoteReactivateOrderItemsEmbedded)) {
            $embedded = QuoteReactivateOrderItemsEmbedded::from($embedded);
        }
