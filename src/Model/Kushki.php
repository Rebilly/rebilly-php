...
class Kushki extends GatewayAccount
{
    ...
    public function setCredentials(KushkiCredentials|array $credentials): static
    {
        if (!($credentials instanceof KushkiCredentials)) {
            $credentials = KushkiCredentials::from($credentials);
        }
    ...
    public function getSettings(): ?KushkiSettings
    {
        return $this->fields['settings'] ?? null;
    }

    public function setSettings(null|KushkiSettings|array $settings): static
    {
        if ($settings !== null && !($settings instanceof KushkiSettings)) {
            $settings = KushkiSettings::from($settings);
        }
