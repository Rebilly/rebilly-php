...
class PlanSubscriptionPlan implements Plan
{
    use HasMetadata;
    ...
    public function getMeteredBilling(): ?PlanSubscriptionPlanMeteredBilling
    {
        return $this->fields['meteredBilling'] ?? null;
    }

    public function setMeteredBilling(null|PlanSubscriptionPlanMeteredBilling|array $meteredBilling): static
    {
        if ($meteredBilling !== null && !($meteredBilling instanceof PlanSubscriptionPlanMeteredBilling)) {
            $meteredBilling = PlanSubscriptionPlanMeteredBilling::from($meteredBilling);
        }
