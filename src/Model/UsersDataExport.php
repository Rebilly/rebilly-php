...
class UsersDataExport implements DataExport
{
    use HasMetadata;
    ...
    public function getDateRange(): ?UsersDataExportDateRange
    {
        return $this->fields['dateRange'] ?? null;
    }

    public function setDateRange(null|UsersDataExportDateRange|array $dateRange): static
    {
        if ($dateRange !== null && !($dateRange instanceof UsersDataExportDateRange)) {
            $dateRange = UsersDataExportDateRange::from($dateRange);
        }
    ...
    public function getEmbedded(): ?UsersDataExportEmbedded
    {
        return $this->fields['_embedded'] ?? null;
    }

    public function setEmbedded(null|UsersDataExportEmbedded|array $embedded): static
    {
        if ($embedded !== null && !($embedded instanceof UsersDataExportEmbedded)) {
            $embedded = UsersDataExportEmbedded::from($embedded);
        }
