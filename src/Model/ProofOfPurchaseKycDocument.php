...
class ProofOfPurchaseKycDocument implements KycDocument
{
    ...
    public function getEmbedded(): ?ProofOfPurchaseKycDocumentEmbedded
    {
        return $this->fields['_embedded'] ?? null;
    }

    public function setEmbedded(null|ProofOfPurchaseKycDocumentEmbedded|array $embedded): static
    {
        if ($embedded !== null && !($embedded instanceof ProofOfPurchaseKycDocumentEmbedded)) {
            $embedded = ProofOfPurchaseKycDocumentEmbedded::from($embedded);
        }
