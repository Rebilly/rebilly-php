...
class FutureRenewals implements JsonSerializable
{
    ...
    /**
     * @return null|FutureRenewalsData[]
     */
    ...
    public function setData(null|array $data): static
    {
        $data = $data !== null ? array_map(
            fn ($value) => $value instanceof FutureRenewalsData ? $value : FutureRenewalsData::from($value),
            $data,
        ) : null;
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('data', $this->fields)) {
            $data['data'] = $this->fields['data'] !== null
                ? array_map(
                    static fn (FutureRenewalsData $futureRenewalsData) => $futureRenewalsData->jsonSerialize(),
                    $this->fields['data'],
                )
                : null;
        }
