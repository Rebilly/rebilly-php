...
class TrialOnlyPlanDetails implements Plan
{
    use HasMetadata;
    ...
    public function getTrial(): TrialOnlyPlanDetailsTrial
    {
        return $this->fields['trial'];
    }

    public function setTrial(TrialOnlyPlanDetailsTrial|array $trial): static
    {
        if (!($trial instanceof TrialOnlyPlanDetailsTrial)) {
            $trial = TrialOnlyPlanDetailsTrial::from($trial);
        }
