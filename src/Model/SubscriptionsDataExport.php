...
class SubscriptionsDataExport implements DataExport, JsonSerializable
{
    ...
    public function getEmbedded(): ?SubscriptionsDataExportEmbedded
    {
        return $this->fields['_embedded'] ?? null;
    }

    public function setEmbedded(null|SubscriptionsDataExportEmbedded|array $embedded): static
    {
        if ($embedded !== null && !($embedded instanceof SubscriptionsDataExportEmbedded)) {
            $embedded = SubscriptionsDataExportEmbedded::from($embedded);
        }
