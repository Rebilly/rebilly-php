...
class ReportDisputes implements JsonSerializable
{
    ...
    /**
     * @return null|ReportDisputesData[]
     */
    ...
    public function setData(null|array $data): static
    {
        $data = $data !== null ? array_map(
            fn ($value) => $value instanceof ReportDisputesData ? $value : ReportDisputesData::from($value),
            $data,
        ) : null;
    ...
    public function jsonSerialize(): array
    {
        ...
        if (array_key_exists('data', $this->fields)) {
            $data['data'] = $this->fields['data'] !== null
                ? array_map(
                    static fn (ReportDisputesData $reportDisputesData) => $reportDisputesData->jsonSerialize(),
                    $this->fields['data'],
                )
                : null;
        }
