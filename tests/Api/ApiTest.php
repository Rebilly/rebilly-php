...
class ApiTest extends TestCase
{
    ...
    public function userService()
    {
        ...
        $handler
            ...
            ->method('__invoke')
            ->will($this->returnValue(
                $client->createResponse()->withHeader('Location', 'reporting-currencies')
            ));
        $client = new Client([
            'apiKey' => 'QWERTY',
            'httpHandler' => $handler,
        ...
        $service = $client->users();
        $result = $service->reportingCurrencies();
        $this->assertInstanceOf(Entities\ReportingCurrencies::class, $result);
        ...
        $handler
            ...
            ->method('__invoke')
            ->will($this->returnValue(
                $client->createResponse()->withHeader('Location', 'users/userId/password')
            ));
        $client = new Client([
            'apiKey' => 'QWERTY',
            'httpHandler' => $handler,
