...
class ApiTest extends TestCase
{
    ...
    public function provideEntityClasses(): iterable
    {
        ...
        $cases = [
            ...
            [Entities\WebhookCredential::class, null, ['hash']],
            ...
            [Entities\PlaidCredential::class, null, ['hash']],
            [Entities\ExperianCredential::class, null, ['hash']],
            [Entities\TaxJarCredential::class, null, ['hash']],
